...
public class bussinessCustomer extends cibcCustomer{

	public bussinessCustomer(String customerSinnumber, String customerName, String customerGender, int customerAge,
